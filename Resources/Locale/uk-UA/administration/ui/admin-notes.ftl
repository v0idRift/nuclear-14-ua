...
admin-notes-round-id = Круглий ідентифікатор: {$id}
admin-notes-round-id-unknown = Круглий ідентифікатор: Невідомий
...
admin-notes-edited = Останнє редагування {$author} від {$date}
admin-notes-unbanned = Видалено {$admin} на {$date}
admin-notes-message-desc = [color=white]Ви отримали { $count ->
    [1] адміністративне повідомлення
    *[other] адміністративні повідомлення
} з часу останньої гри на цьому сервері[/color]
...
admin-notes-message-dismiss = Наразі вільні
...
admin-note-editor-title-existing = Примітка про редагування {$id} у {$player} від {$author}
...
admin-note-editor-type-server-ban = Заборона сервера
admin-note-editor-type-role-ban = Заборона ролей
...
admin-note-editor-expiry-checkbox-tooltip = Перевірте це, щоб закінчився термін дії
...
admin-note-editor-expiry-placeholder = Введіть дату закінчення терміну придатності (рррр-ММ-дд ЧЧ:мм:сс)
...
# Список спостереження та вхід в систему
