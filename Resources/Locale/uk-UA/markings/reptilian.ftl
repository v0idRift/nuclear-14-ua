...
marking-LizardFrillsShort = Оборки ящірки (короткометражка)

marking-LizardFrillsSimple-frills_simple = Оборки з ящірок (прості)
marking-LizardFrillsSimple = Оборки з ящірок (прості)

marking-LizardFrillsAquatic-frills_aquatic = Ящіркові оборки (водні)
marking-LizardFrillsAquatic = Ящіркові оборки (водні)

marking-LizardHornsAngler-horns_angler = Роги ящірки (рибалки)
marking-LizardHornsAngler = Роги ящірки (рибалки)
...
marking-LizardHornsRam = Роги ящірки (барана)
...
marking-LizardTailLTiger = Хвіст ящірки (світло-тигрові смуги)
...
marking-LizardFrillsAxolotl = Ящірка з оборками (Аксолотль)
...
marking-LizardFrillsHood = Оборки з ящірки (капюшон)
...
marking-LizardHornsFloppyKoboldEars = Вуха ящірки (Floppy Kobold)

marking-LizardChestUnderbelly-body_underbelly = Грудна клітка ящірки (підчерев'я)
marking-LizardChestUnderbelly = Грудна клітка ящірки (підчерев'я)
