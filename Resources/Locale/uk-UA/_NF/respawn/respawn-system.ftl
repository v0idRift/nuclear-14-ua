...
ghost-respawn-rules-window-rules = Відродження відбувається за суворим Правилом нового життя:
    Незалежно від того, яким персонажем ви вирішите повернутися,
    ви нічого не пам'ятаєте після втрати свідомості,
