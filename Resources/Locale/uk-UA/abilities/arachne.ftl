...
uncocoon-start-second-person = Ви починаєте звільняти {THE($target)}.
uncocoon-start-third-person = {CAPITALIZE(THE($spider))} починає звільняти {THE($target)}.
uncocoon = Розкоконити