...
action-name-assay = Аналіз
action-description-assay = Дослідити сутність на близькій відстані, щоб отримати метафоричну інформацію про будь-які здібності, якими вона може володіти
