...
network-configurator-link-mode-stopped = Припинився зв'язок.
network-configurator-mode-link = Посилання
network-configurator-mode-list = Список
network-configurator-switched-mode = Переключив режим на: {$mode}

# Дієслова
network-configurator-save-device = Зберегти пристрій
network-configurator-configure = Налаштувати
network-configurator-switch-mode = Режим перемикання
network-configurator-link-defaults = Посилання за замовчуванням
network-configurator-start-link = Початкове посилання
network-configurator-link = Посилання
...
network-configurator-ui-clear-button = Чисто
network-configurator-ui-count-label = {$count} Пристрої

# підказки
network-configurator-tooltip-set = Встановлює цільовий список пристроїв
...
network-configurator-tooltip-show = Показати голографічну візуалізацію списку пристроїв-мішеней

# дослідити
network-configurator-examine-mode-link = [color=red]Посилання[/color]
...
network-configurator-examine-switch-modes = Натисніть {$key} для перемикання режимів

# стан елемента
network-configurator-item-status-label = Поточний режим: {$mode}
{$keybinding} для перемикання режиму
