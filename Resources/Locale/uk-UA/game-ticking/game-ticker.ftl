...
latejoin-arrivals-dumped-from-shuttle = Таємнича сила не дозволяє вам покинути станцію з шатлом прибуття.
latejoin-arrivals-teleport-to-spawn = Таємнича сила телепортує вас з шатла прибуття. Безпечної зміни!