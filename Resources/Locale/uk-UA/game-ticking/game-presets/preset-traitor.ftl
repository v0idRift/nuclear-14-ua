...
# Відображається в кінці раунду Зрадника
traitor-role-uplink-implant = Ваш імплант зв'язку активовано, доступ до нього через панель швидкого доступу.
    Зв'язок безпечний, якщо хтось не видалить його з вашого тіла.

# не потрібен увесь цей текст для меню персонажа
traitor-role-uplink-implant-short = Ваш імплант зв'язку імплантовано. Доступ через панель швидкого доступу.