...
command-description-jobs-isinfinite = Повертає true, якщо вхідне завдання нескінченне, інакше false.
...
command-description-laws-list = Повертає список всіх юридичних осіб, пов'язаних правом.
...
command-description-admins-all = Повертає список ВСІХ адміністраторів, в тому числі і тих, яких було зламано.
...
command-description-stationevent-simulate = Симулює N раундів, протягом яких відбуватимуться події, та виводить кількість входжень кожної події після цього.