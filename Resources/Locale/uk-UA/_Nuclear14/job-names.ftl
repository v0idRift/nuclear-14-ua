...
job-description-ncr-medic = Пригощайте солдатів і пропонуйте послуги мешканцям пустки.
job-name-ncr-sgt = Сержант NCR
job-description-ncr-sgt = Унтер-офіцер у збройних силах НКР. Очолює загін для захисту інтересів NCR в регіоні. За відсутності лейтенанта, керувати базою.
...
job-description-ncr-engineer = Основа будь-якого загону. Ремонтуйте спорядження, встановлюйте оборону та виконуйте завдання під керівництвом Сержанта.