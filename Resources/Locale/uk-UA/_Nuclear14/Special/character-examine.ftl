...
special-appearance-component-examine-charisma-very-low = { CAPITALIZE(SUBJECT($user)) } здається огидним.
...
special-appearance-component-examine-strength = Сила - це {$value}.
special-appearance-component-examine-perception = Сприйняття - це {$value}.
special-appearance-component-examine-endurance = Витривалість - це {$value}.
...
special-component-examine-character-perception = Сприйняття: {$base} + {$modifier} = {$total}
special-component-examine-character-endurance = Витривалість: {$base} + {$modifier} = {$total}
special-component-examine-character-charisma = Харизма: {$base} + {$modifier} = {$total}
special-component-examine-character-intelligence = Інтелект: {$base} + {$modifier} = {$total}
special-component-examine-character-agility = Спритність: {$base} + {$modifier} = {$total}
special-component-examine-character-luck = Вдача {$base} + {$modifier} = {$total}
