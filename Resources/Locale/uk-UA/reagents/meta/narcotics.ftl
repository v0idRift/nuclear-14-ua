...
reagent-desc-happiness = Наповнює вас екстатичним онімінням і спричиняє незначне пошкодження мозку. Викликає сильну залежність. При передозуванні викликає раптові зміни настрою.