...
food-system-force-feed-broadcasted-success = {CAPITALIZE(THE($user))} змусив(-ла) {THE($target)} з'їсти {THE($food)}!
food-system-eat-broadcasted-success = {CAPITALIZE(THE($user))} з'їв(-ла) {THE($food)}!
